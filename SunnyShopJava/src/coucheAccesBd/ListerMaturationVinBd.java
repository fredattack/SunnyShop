...
public class ListerMaturationVinBd extends OperationBd{

private ArrayList<String> laListe;
	
	public List<String> getListe() { return laListe; }
	
	public ListerMaturationVinBd()
	{
	super("ListerMaturationVin");
	}
	...
	CallableStatement sqlCmd = SqlConn.prepareCall("{ call ListerMaturationVin() }");
